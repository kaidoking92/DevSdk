...
class ProviderTwitter
{
	...
	public function getAuthorizationUrl()
	{
		...
		return "https://api.twitter.com/oauth/authorize?{$queryParams}";
	}
	...
	public function getToken()
	{
	    ...
	    $response = file_get_contents("https://api.twitter.com/oauth/authorize?{$queryParams}");
